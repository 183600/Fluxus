...
debugMemory = do
  ...
  -- Force garbage collection to get more accurate stats
  liftIO $ performGC
  debugLog Trace "  Garbage collection performed"
  debugLog Trace "  Note: Detailed GC statistics require GHC-specific imports"