...
compileFileArtifacts inputFile = do
  ...
  let cppFile = replaceExtension inputFile ".cpp"
      renderedCpp = renderCppUnit cppCode
      header = "// Generated by HyperStatic/CXX Compiler\n"
      withHeader =
        if "// Generated by HyperStatic/CXX Compiler" `T.isPrefixOf` renderedCpp
          then renderedCpp
          else header <> renderedCpp
  liftIO $ TIO.writeFile cppFile (withHeader <> "\n")
...
-- Rendering helpers are provided by Fluxus.CodeGen.CPP.AST.
