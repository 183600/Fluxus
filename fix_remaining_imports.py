...
def fix_remaining_imports():
    ...
    # 需要修复的文件和对应的导入
    fixes = {
        'src/Fluxus/AST/Go.hs': [
            'import Fluxus.AST.Go (GoExpr, GoLiteral, GoType, GoDecl, GoStmt, GoField, GoFunction, GoImport)',
            'import Fluxus.CodeGen.CPP.AST (CppDecl, CppExpr, CppStmt, CppType, CppLiteral, CppParam, CppUnit)',
            'import Fluxus.CodeGen.CPP.Go.TypeMapping (Identifier, Located, ModuleName, QualifiedName, GoType, GoField, GoExpr, GoLiteral, CppType)',
            'import Fluxus.CodeGen.CPP.Monad (CppDecl, CppExpr, CppStmt, CppType, CppLiteral, CppParam, CppUnit, CppGenState, CppCodeGenError, CppDiagnostic, DiagnosticSeverity)',
            ...
            'import Fluxus.CodeGen.CPP (CppCase, CppDecl, CppExpr, CppLiteral, CppParam, CppStmt, CppType, CppUnit, CppGenConfig, CppGenState, CppCodeGenFailure, CppCodeGenResult)',
        ...
        'src/Fluxus/Analysis/CommonExprLowering.hs': [
            'import Fluxus.AST.Go (GoExpr, GoLiteral)',
            'import Fluxus.AST.Python (PythonArgument, PythonExpr, PythonLiteral)'
        ],
        'src/Fluxus/CodeGen/CPP/IdentifierSanitizer.hs': [
            'import Fluxus.CodeGen.CPP.AST (CppDecl, CppExpr, CppStmt, CppType, CppLiteral, CppParam, CppUnit)'
        ],
        ...
        'src/Fluxus/Parser/Go/Parser/Common.hs': [
            'import Fluxus.AST.Common (Identifier, Located)'
        ],
