...
func main() {
	fmt.Println("=== Go Channels and Select Statement Tests ===")
	testBasicChannels()
...
func testTimeoutWithSelect() {
	...
	case <-time.After(50 * time.Millisecond):
		fmt.Println("Timeout - could not send message")
	}
}
