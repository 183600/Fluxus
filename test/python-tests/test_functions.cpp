...
int calculate_average(std::vector<int> numbers) {
...
int main() {
    ...
    auto result4 = calculate_average(std::vector<decltype(1)>{1, 2, 3, 4, 5});
    std::cout << "Greeting:" << " " << result1 << std::endl;
    std::cout << "Addition:" << " " << result2 << std::endl;
    std::cout << "Multiplication:" << " " << result3 << std::endl;
    std::cout << "Average:" << " " << result4 << std::endl;
    auto double_ = [](auto x) { return  x * 2; };
    auto square = [](auto x) { return std::pow( x, 2); };
    std::cout << "Double of 10:" << " " << double(10) << std::endl;
