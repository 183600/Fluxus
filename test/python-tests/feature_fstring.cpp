...
int main() {
    ...
    auto message = to_str("Hello, ") + to_str(name) + to_str("!");
    std::cout << message << std::endl;
    auto info = to_str(name) + to_str(" is ") + to_str(age) + to_str(" years old.");
    std::cout << info << std::endl;
    auto birth_year = 2024 - age;
    auto year_message = to_str(name) + to_str(" was born around ") + to_str(birth_year) + to_str(".");
    std::cout << year_message << std::endl;
    auto temp_message = to_str("The temperature is ") + ([&](){ std::ostringstream os; os.setf(std::ios::fixed); os<<std::setprecision(1); os<<temperature; return os.str(); }()) + to_str("°C");
