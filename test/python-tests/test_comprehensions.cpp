...
int main() {
    ...
    auto divisible_by_3_or_5 = 0;
    std::cout << "Divisible by 3 or 5:" << " " << divisible_by_3_or_5 << std::endl;
    auto matrix = 0;
    ...
    auto word_lengths = 0;
    std::cout << "Word lengths:" << " " << word_lengths << std::endl;
    auto unique_chars = 0;
    std::cout << "Unique characters:" << " " << unique_chars << std::endl;
    auto pairs = 0;
    std::cout << "Pairs:" << " " << pairs << std::endl;
    auto result = 0;
    std::cout << "Even/odd:" << " " << result << std::endl;
    return 0;
}
