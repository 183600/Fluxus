...
func testAtomicOperations() {
	...
	fmt.Printf("Atomic counter: %d, swapped: %t\n", counter, swapped)
...
func (q *Queue[T]) Enqueue(item T) bool {
	if (q.tail+1)%len(q.items) == q.head {
...
func (q *Queue[T]) Size() int {
	return (q.tail - q.head + len(q.items)) % len(q.items)
}

func testAdvancedGenerics() {
	// Min/Max with different types
...
func main() {
	...
	fmt.Println("\n8. Testing Atomic Operations:")
	testAtomicOperations()
	
	fmt.Println("\n9. Testing Custom Errors:")
	testCustomErrors()
	
	fmt.Println("\n10. Testing Panic and Recover:")
	testPanicRecover()
	
	fmt.Println("\n11. Testing Deep Reflection:")
	testDeepReflection()
	
	fmt.Println("\n12. Testing Struct Tags:")
	testStructTags()
	
	fmt.Println("\n13. Testing Unsafe Pointer Arithmetic:")
	testUnsafePointerArithmetic()
	
	fmt.Println("\n14. Testing Type Punning:")
	testTypePunning()
	
	fmt.Println("\n15. Testing Advanced Generics:")
	testAdvancedGenerics()
