...
int main() {
    ...
    auto doubled = 0;
    auto person = std::unordered_map<std::string, std::string>{{"name", "Alice"}, {"age", to_str(30)}};
    auto name = person["name"];
    auto calc = Calculator();
    auto result1 = calc.add(5, 3);
    auto result2 = calc.multiply(4, 7);
    std::cout << to_str("Sum: ") << to_str(sum_result) << std::endl;
    std::cout << to_str("Product: ") << to_str(product) << std::endl;
    std::cout << to_str("Factorial(5): ") << to_str(factorial(5)) << std::endl;
    std::cout << to_str("Doubled numbers: ") << to_str(doubled) << std::endl;
    std::cout << to_str("Person name: ") << to_str(name) << std::endl;
    std::cout << to_str("Calc add: ") << to_str(result1) << std::endl;
    std::cout << to_str("Calc multiply: ") << to_str(result2) << std::endl;
    return 0;
}
