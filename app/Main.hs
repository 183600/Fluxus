...
printUsage = do
  ...
  putStrLn "  --enable-analysis     Enable static analysis (default)"
  putStrLn "  --disable-analysis    Skip static analysis"
  putStrLn ""
  ...
  putStrLn "  --stop-at-codegen     Stop after generating C++ source (skip native compilation)"
  ...
  putStrLn "  FLUXUS_ENABLE_ANALYSIS  Enable static analysis (1/0)"
  putStrLn "  FLUXUS_STOP_AT_CODEGEN  Stop after C++ code generation (1/0)"
  putStrLn ""
